...
if selected_status_6 == 'GRU':
    ...
    def plot_multi_step(history, prediction1):
        ...
        plt.plot(np.arange(len(train_data),len(train_data)+len(y_test)),y_test,marker='.',label="actual data",linewidth=6)
        # plt.plot(np.array(prediction1),label='Forecasted with MLP',linewidth=3)
        plt.plot(np.arange(len(train_data),len(train_data)+len(y_test)),prediction_gru,'r',label="prediction",linewidth=6)
...
# #=======================================================================================================================
    ...
    def plot_multi_step(history, prediction1):
        ...
        plt.plot(np.arange(len(train_data),len(train_data)+len(y_test)),y_test,marker='.',label="actual data",linewidth=6)
        # plt.plot(np.array(prediction1),label='Forecasted with MLP',linewidth=3)
        plt.plot(np.arange(len(train_data),len(train_data)+len(y_test)),prediction_bilstm,'r',label="prediction",linewidth=6)
...
# ===========================================================================================================================
    ...
    def plot_multi_step(history, prediction1):
        ...
        # range_future = list(range(range_history, range_history + len(prediction1)))
        plt.plot(np.arange(range_history), np.array(history),'g' ,label='History',linewidth=6)
        plt.plot(np.arange(len(y_train),len(y_train)+len(y_test2)),y_test2,marker='.',label="actual data",linewidth=6)
        # plt.plot(np.array(prediction1),label='Forecasted with MLP',linewidth=3)
        plt.plot(np.arange(len(y_train),len(y_train)+len(y_test)),np.array(preds)*MAX,'r',label="prediction",linewidth=6)
...
#=================================================================================================================================
    ...
    def plot_multi_step(history, prediction1):
        ...
        range_future = list(range(range_history, range_history + len(prediction1)))
        plt.plot(np.arange(range_history), np.array(history),'g' ,label='History',linewidth=6)
        plt.plot(np.arange(len(train_data_y),len(train_data_y)+len(test_data_y)),test_data_y,marker='.',label="actual data",linewidth=6)
        # plt.plot(np.array(prediction1),label='Forecasted with MLP',linewidth=3)
        # plt.plot(np.arange(len(train_data_y),len(train_data_y)+len(test_data_y)),actual_predictions,'r',label="prediction",linewidth=6)
        plt.plot(range_future, np.array(prediction1),label='Forecasted with LSTM',color="r",linewidth=6)
        # ax.axvline('14', color='black', ls='--')
        if selected_status_7 == 7:
            plt.vlines(7.5,-10,600, linestyles='dashed',colors='k',linewidth=10,)
        elif selected_status_7 == 14:
...
#=================================================================================================================================
    ...
    def plot_multi_step(history, prediction1):
        ...
        plt.plot(np.arange(len(y_train),len(y_train)+len(y_test)),y_test,marker='.',label="actual data",linewidth=6)
        # plt.plot(np.array(prediction1),label='Forecasted with MLP',linewidth=3)
        plt.plot(np.arange(len(y_train),len(y_train)+len(y_test)),prediction_MLP,'r',label="prediction",linewidth=6)
...
#=================================================================================================================================
    ...
    st.subheader("Electric Vehicle Charging Prediction")
    ...
    def plot_multi_step(history, prediction1):
        ...
        plt.plot(np.arange(len(y_train),len(y_train)+len(y_test2)),y_test2,marker='.',label="actual data",linewidth=6)
        # plt.plot(np.array(prediction1),label='Forecasted with MLP',linewidth=3)
        plt.plot(np.arange(len(y_train),len(y_train)+len(y_test)),df_test['Prediction'],'r',label="prediction",linewidth=6)
...
# =================================================================================================
    ...
    def plot_multi_step(history, prediction1):
        ...
        plt.plot(np.arange(len(spots_train2),len(spots_train2)+len(y_test)),y_test,marker='.',label="actual data",linewidth=6)
        # plt.plot(np.array(prediction1),label='Forecasted with MLP',linewidth=3)
        plt.plot(np.arange(len(spots_train2),len(spots_train2)+len(y_test)),pred,'r',label="prediction",linewidth=6)
